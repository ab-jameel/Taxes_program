...
Public Class Buy_Form
    ...
    Sub The_Table()
        ...
        da = New OleDbDataAdapter("select The_Table.ID, The_Table.Num, The_Table.Date1, The_Table.Describe1,
                                  ...
                                  and The_Table.Comer_Name = Comers.ID ", Con)
        da.Fill(dtTable1)
    ...
    Sub Connection1()
        ...
        IDComer.DataBindings.Add("text", dtTable1, "Comer_Name")
        NComer.DataBindings.Add("text", dtTable1, "Comer_Name1")
        NumVat.DataBindings.Add("text", dtTable1, "Num_VAT")
        TextBox7.DataBindings.Add("text", dtTable1, "ID")
    End Sub
    ...
    Sub Cut1()
        ...
        IDComer.DataBindings.Clear()
        NComer.DataBindings.Clear()
        NumVat.DataBindings.Clear()
        TextBox7.DataBindings.Clear()
    End Sub

    Private Sub Buy_Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            The_Table()
            TextBox6.Text = "Start"
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Try
            If TextBox1.Text <> "" And TextBox2.Text <> "" And TextBox3.Text <> "" And IDComer.Text <> "" Then
                Dim dts As Date = DateTimePicker1.Value.ToShortDateString
                If TextBox6.Text = "Add" Then
                    dtTable1.Rows.Add()
                    Postion = dtTable1.Rows.Count - 1
                    Insert_Buy(TextBox1.Text, dts, TextBox4.Text, TextBox2.Text, TextBox3.Text, "مشتريات", IDComer.Text)
                End If
                If TextBox6.Text = "Edit" Then
                    NBR = TextBox7.Text
                    Update_Buy(TextBox1.Text, dts, TextBox4.Text, TextBox2.Text, TextBox3.Text, "مشتريات", IDComer.Text)
                    NBR = Nothing
                End If
                ...
                TextBox6.Text = ""
                Close()
                Home_Form.TextBox1.Text = "open buy"
            Else
                Error_Form.MdiParent = Home_Form
                Error_Form.Show()
                Error_Form.TextBox1.Text = "Buy"
                Me.Enabled = False
            End If
        Catch
            MsgBox("يوجد خطأ الرجاء التواصل مع الدعم الفني",, "خطأ")
    ...
    Private Sub TextBox2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox2.KeyPress
        Try
            EnterNumber(sender, e, TextBox2, 5)
        Catch
            MsgBox("يوجد خطأ الرجاء التواصل مع الدعم الفني",, "خطأ")
        End Try
    End Sub

    Private Sub BrevComer_Click(sender As Object, e As EventArgs) Handles BrevComer.Click
        Try
            Me.Enabled = False
            Breview_Comers.MdiParent = Home_Form
            Breview_Comers.Show()
        Catch
            MsgBox("يوجد خطأ الرجاء التواصل مع الدعم الفني",, "خطأ")
        End Try
